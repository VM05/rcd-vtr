...
var $owl = $('.carrusel-peliculas .owl-carousel');
var $owl2 = $('#carrusel-principal .owl-carousel');
$owl.children().each(function (index) {
  $(this).attr('data-hash', index); // NB: .attr() instead of .data()
});
...
$(document).on('click', '.owl-item>div', function () {
  ...
  var $speed = 300; // in ms
  $owl.trigger('to.owl.carousel', [$(this).data('hash'), $speed]);
});
